...
-- reduce a proposition to a summary value
...
-- the number of variables in a proposition, including repetitions
varCount :: Prop a -> Int
...
vars (Equiv p q) = Set.union (vars p) (vars q)
